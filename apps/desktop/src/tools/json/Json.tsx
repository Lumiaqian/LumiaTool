...
export default function Json(): React.ReactElement {
    ...
    return (
        <div className="lumia-generator-editor-family lumia-editor-page lumia-json-editor-page lumia-json-workspace">
            <div>
                <Tabs
                    value={action.current.tabs}
                    onChange={value => {
                        action.current.tabs = value;
                    }}
                    lists={[
                ...
                >
                    <Align className="lumia-json-command-bar">
                        <Bool
                            size="small"
                            border
                            value={action.current.option.info.line}
                            onChange={value => {
                                action.current.option.info.line = value;
                            }}
                        ...
                        />
                        <Dropdown
                            onSelect={(value: RenameType) => rename(value)}
                    ...
                    <Align>
                        {pathLists.map(item => (
                            <Button
                                ...
                                onClick={() => {
                                    action.current.option.path.type = item.value;
                                }}
                            />
                        ))}
                    </Align>
                        ...
                        <div style={layoutStyle}>
                            ...
                            {action.current.expand_type === "to" && (
                                <SerializeOutput
                                    ...
                                    onChange={value => {
                                        action.current.option.to = value;
                                    }}
                                />
                            )}
                            {action.current.expand_type === "path" && (
                                <Path
                                    ...
                                    onChange={value => {
                                        action.current.option.path = value;
                                    }}
                                    onSuccess={() => action.save()}
                                />
                            )}
                            {action.current.expand_type === "json_schema" && (
                                <Schema
                                    ...
                                    onChange={value => {
                                        action.current.option.schema = value;
                                    }}
                                    onSuccess={() => action.save()}
                                />
                            )}
            ...
            <ExtendPage value={toObjectOpen} onChange={setToObjectOpen}>
                <ToObject
                    ...
                    onChange={value => {
                        action.current.option.to_object = value;
                    }}
                    json={inputSerialize}
                    onSuccess={() => action.save()}
                />
