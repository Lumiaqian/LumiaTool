...
type DecryptProps = { type?: string };

function Decrypt({ type = "des" }: DecryptProps) {
    ...
    const output = useMemo(() => {
        ...
        try {
            return Text.fromBase64((type === "des" ? des : tripleDES).decrypt(input.text.toBase64(), currentOption));
        } catch (caught) {
