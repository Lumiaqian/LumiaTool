import type {Locale, LocaleLists} from "@/types";
import {getSystemLocale} from "@/lib/desktop";
import {locales} from "@/generated/data";
import event from "@/event";

export const LOCALE_DETAIL = locales.detail
// 默认语言
export const DEFAULT_LOCALE = getSystemLocale()
// 运行时当前语言
